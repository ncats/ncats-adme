...
try:
    ...
    rlm_rf_model = pickle.load(BytesIO(rf_pkl_file_request.content))
    ...
    rlm_dnn_model = pickle.load(BytesIO(pkl_file_request.content))
    ...
    rlm_tokenizer = pickle.load(BytesIO(tokfile_request.content))
    ...
    rlm_lstm_model = load_model(BytesIO(lstm_model_request.content), custom_objects=SeqSelfAttention.get_custom_objects())
